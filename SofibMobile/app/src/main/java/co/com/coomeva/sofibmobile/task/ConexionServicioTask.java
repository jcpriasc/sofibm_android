 ...
 */
public class ConexionServicioTask  extends AsyncTask<String,Integer,JSONArray>{
...
//    private List<NameValuePair> listParams;
    ...
    public ConexionServicioTask(Context context, String service_name, String listParams){
