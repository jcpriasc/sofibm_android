...
import co.com.coomeva.sofibmobile.fragments.NotaCreditoDebitoFragment;
...
public class NotasCreditoDebitoView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nota_credito_debito);
                        ...
                        try {
                            ...
                            switch (menuItem.getItemId()) {
                                ...
                                case R.id.menu_servicio_asistencial:
                                    if (OpcionesSecundariasFragment.consultarServiciosAsistenciales(getApplicationContext().getResources().getString(R.string.complement_ServiciosAsistenciales), params, NotasCreditoDebitoView.this)) {
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.fragment_container_nota_credito_debito, new NotaCreditoDebitoFragment(), "NotaCreditoDebitoFragment").commit();
