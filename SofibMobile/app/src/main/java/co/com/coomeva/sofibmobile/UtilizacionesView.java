...
import co.com.coomeva.sofibmobile.fragments.UtilizacionesFragment;
import co.com.coomeva.sofibmobile.utils.Constantes;

public class UtilizacionesView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_utilizaciones);
                        ...
                        try {
                            ...
                            switch (menuItem.getItemId()) {
                                case R.id.menu_autorizaciones:
                                    ...
                                    if (OpcionesSecundariasFragment.consultarAutorizaciones(getApplicationContext().getResources().getString(R.string.complement_Autorizaciones), params, UtilizacionesView.this)){
                                ...
                                case R.id.menu_servicio_asistencial:
                                    if (OpcionesSecundariasFragment.consultarServiciosAsistenciales(getApplicationContext().getResources().getString(R.string.complement_ServiciosAsistenciales), params, UtilizacionesView.this)) {
                                ...
                                case R.id.menu_informes_medicos:
                                    params = getApplicationContext().getResources().getString(R.string.address_service_token)+ ConsultaSolicitudAtencionView.solicitudAtencionSeleccionada.getNumeroSolicitud();
                                    if (OpcionesSecundariasFragment.consultarInformesMedicos(getApplicationContext().getResources().getString(R.string.complement_InformesMedicos), params, UtilizacionesView.this)) {
                                ...
                                case R.id.menu_documentos_medicos:
                                    params = getApplicationContext().getResources().getString(R.string.address_service_token)+ ConsultaSolicitudAtencionView.solicitudAtencionSeleccionada.getNumeroSolicitud();
                                    if (OpcionesSecundariasFragment.consultarDocumentosMedicos(getApplicationContext().getResources().getString(R.string.complement_DocumentosMedicos), params, UtilizacionesView.this)){
                                ...
                                case R.id.menu_epicrisis:
                                    params = getApplicationContext().getResources().getString(R.string.address_service_token)+ ConsultaSolicitudAtencionView.solicitudAtencionSeleccionada.getNumeroSolicitud();
                                    if (OpcionesSecundariasFragment.consultarEpicrisis(getApplicationContext().getResources().getString(R.string.complement_Epicrisis), params, UtilizacionesView.this)){
                                ...
                                case R.id.menu_procedimientos_adicionales:
                                    params = getApplicationContext().getResources().getString(R.string.address_service_token)+ ConsultaSolicitudAtencionView.solicitudAtencionSeleccionada.getNumeroSolicitud();
                                    if (OpcionesSecundariasFragment.consultarProcedimientosAdicionales(getApplicationContext().getResources().getString(R.string.complement_ProcedimientoAdicionales), params, UtilizacionesView.this)){
                                ...
                                case R.id.menu_funcionarios_externos:
                                    params = getApplicationContext().getResources().getString(R.string.address_service_token)+ ConsultaSolicitudAtencionView.solicitudAtencionSeleccionada.getNumeroSolicitud();
                                    if (OpcionesSecundariasFragment.consultarFuncionariosExternos(getApplicationContext().getResources().getString(R.string.complement_FuncionariosExternos), params, UtilizacionesView.this)){
                                ...
                                case R.id.menu_consultar_solicitudes_aprobacion:
                                    if( LoginView.usuarioSesion != null && LoginView.usuarioSesion.getTipoUsuario().equals( getApplicationContext().getResources().getString(R.string.usuario_interno)) ){
                                        ...
                                        if (OpcionesSecundariasFragment.consultarSolicitudAprobacion(getApplicationContext().getResources().getString(R.string.complement_aprobacion), params, UtilizacionesView.this)){
                                ...
                                case R.id.menu_servicio_no_asistencial:
                                    params = getApplicationContext().getResources().getString(R.string.address_service_token)+ ConsultaSolicitudAtencionView.solicitudAtencionSeleccionada.getNumeroSolicitud();
                                    if (OpcionesSecundariasFragment.consultarServicioNoAsistencial(getApplicationContext().getResources().getString(R.string.complement_serviciosNoAsistenciales), params, UtilizacionesView.this)){
                                ...
                                case R.id.menu_giro:
                                    params = getApplicationContext().getResources().getString(R.string.address_service_token)+ ConsultaSolicitudAtencionView.solicitudAtencionSeleccionada.getNumeroSolicitud();
                                    if (OpcionesSecundariasFragment.consultarGiros(getApplicationContext().getResources().getString(R.string.complement_giro), params, UtilizacionesView.this)){
                                ...
                                case R.id.menu_nota_credito_giro:
                                    params = getApplicationContext().getResources().getString(R.string.address_service_token)+ ConsultaSolicitudAtencionView.solicitudAtencionSeleccionada.getNumeroSolicitud();
                                    if (OpcionesSecundariasFragment.consultarNotasCreditoGiro(getApplicationContext().getResources().getString(R.string.complement_giro_notaCredito), params, UtilizacionesView.this)){
                                ...
                                case R.id.menu_lbl_titulo_facturafactura:
                                    params = getApplicationContext().getResources().getString(R.string.address_service_token)+ ConsultaSolicitudAtencionView.solicitudAtencionSeleccionada.getNumeroSolicitud();
                                    if (OpcionesSecundariasFragment.consultarFactura(getApplicationContext().getResources().getString(R.string.complement_factura), params, UtilizacionesView.this)){
                                ...
                                case R.id.menu_notas_credito_debito:
                                    params = getApplicationContext().getResources().getString(R.string.address_service_token)+ ConsultaSolicitudAtencionView.solicitudAtencionSeleccionada.getNumeroSolicitud();
                                    if (OpcionesSecundariasFragment.consultarNotasCreditoDebito(getApplicationContext().getResources().getString(R.string.complement_nota), params, UtilizacionesView.this)){
                                ...
                                case R.id.menu_encuesta_satisfaccion:
                                    params = getApplicationContext().getResources().getString(R.string.address_service_token)+ ConsultaSolicitudAtencionView.solicitudAtencionSeleccionada.getNumeroSolicitud();
                                    if (OpcionesSecundariasFragment.consultarEncuesta(getApplicationContext().getResources().getString(R.string.complement_encuesta), params, UtilizacionesView.this)){
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.fragment_container_utilizaciones, new UtilizacionesFragment(), "UtilizacionesFragment").commit();
